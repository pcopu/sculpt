...
A diagonal tip keeps the cup near the edge but sends coffee across the wood first.
"""
from pathlib import Path
import json,re
root=Path(__file__).resolve().parents[1]
keys=[[0,[1.43,-1.65,1.16],[.05,-.13,.51],49],[94,[.72,-.94,.84],[.275,-.312,.60],59],[164,[.79,-.91,.78],[.355,-.365,.575],58],[194,[.83,-1.05,.55],[.43,-.50,.31],50],[222,[.90,-1.16,.34],[.50,-.65,.045],52],[300,[.96,-1.22,.35],[.52,-.69,.055],54],[384,[1.02,-1.29,.43],[.50,-.72,.083],52],[527,[1.42,-1.84,1.13],[.22,-.26,.35],47]]
...
change(["domain=box('COFFEE / Mantaflow FLIP',(.29,-.64,.365)"],"domain=box('COFFEE / Mantaflow FLIP',(.446,-.64,.365)")
...
# Beer-Lambert absorption: transparent amber in thin sheets, dark in the cup.
...
print('Locked diagonal spill, contact-first staging, amber volume optics and synchronized camera')
